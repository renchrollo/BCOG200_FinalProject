...
nnfs.init()
'''
The major improvements to the efficacy of the model were implemented through adding 2 more layers
and tweaking some of the major functions to improve model efficiency

Changes will be highlighted through commented lines, descriptions of the functions can be found in the previous model
file.
'''
class Layer_Comp:
...
# ALL HIDDEN LAYERS USE THE ReLU FUNCTION AND CONTAIN 5 NEURONS
...
# ADDED TWO MORE LAYERS TO IMPROVE MODEL PREDICTIONS (BOTH USE ReLU)
...
# "activation4" implements the softmax function
